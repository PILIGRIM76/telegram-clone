...
const { SQLiteStorage } = require('./SQLiteStorage.complete.js');
...
// Инициализация хранилища в зависимости от STORAGE_TYPE
let db;
if (STORAGE_TYPE === 'sqlite') {
    db = new SQLiteStorage();
    console.log('[DB] Используется SQLiteStorage');
} else {
    db = new MemoryStorage();
    console.log('[DB] Используется MemoryStorage');
}

module.exports = { db, STORAGE_TYPE, MemoryStorage, SQLiteStorage };