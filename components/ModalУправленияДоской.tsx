...
import ModalДобавленияОбъявления from './ModalДобавленияОбъявления';
import ModalПродленияДоски from './ModalПродленияДоски';
...
const ModalУправленияДоской: React.FC<Пропсы> = ({ доска, приЗакрытии, приОбновлении }) => {
...
export default ModalУправленияДоской;
